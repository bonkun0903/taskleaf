...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<rspec-core>.freeze, ["~> 3.11.0"])
    s.add_runtime_dependency(%q<rspec-expectations>.freeze, ["~> 3.11.0"])
    s.add_runtime_dependency(%q<rspec-mocks>.freeze, ["~> 3.11.0"])
  else
    s.add_dependency(%q<rspec-core>.freeze, ["~> 3.11.0"])
    s.add_dependency(%q<rspec-expectations>.freeze, ["~> 3.11.0"])
    s.add_dependency(%q<rspec-mocks>.freeze, ["~> 3.11.0"])
  end
end
